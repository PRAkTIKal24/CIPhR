    ...
    def strip_references_section(self, text: str) -> str:
        ...
        for pattern in ref_patterns:
            ...
            if match:
                ...
                logging.debug(f"Stripped references section. Original: {len(text)} chars, After: {len(stripped_text)} chars")
        ...
        for pattern in conclusion_patterns:
            ...
            if match:
                ...
                if conclusions:
                    ...
                    logging.debug(f"Extracted {section_name} section: {len(conclusions)} chars")
                    return conclusions
                    
        return None

    def process_content_for_llm(self, title: str, abstract: str, content: str, max_content_length: int) -> str:
        """
        ...
        if len(content_no_refs) > max_content_length:
            ...
            if conclusions:
                ...
                logging.info(f"Long paper processing: Main content {len(main_content)} chars + Conclusions {len(conclusions)} chars")
            else:
            ...
            logging.debug(f"Standard processing: Content fits within {max_content_length} char limit")
