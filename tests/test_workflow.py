...
def test_complete_append_workflow():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        mock_results = [
            {
                ...
                "llm_answers": {
                    ...
                    LLM_QUESTIONS[1]: "Yes, searching for WIMP dark matter interactions",
        ...
        should_append1 = filename1 == 'physics_papers.md' and os.path.exists(output_path1)
        ...
        should_append2 = filename2 == 'physics_papers.md' and os.path.exists(output_path2)
        ...
        if should_append2:
            ...
            markdown_append = generate_markdown_table(new_mock_results, include_header=False)
